$(function() {
  ...
  $('[data-scrollmagic]').each(function (index, elem) {
    ...
    tl.add("start")
      ...
      .fromTo(bot, 0.4, { y: '50px', opacity: 0 }, { y: 0, opacity: 1, ease: Power2.EaseInOut }, "start")
      .fromTo(niu, 0.4, { y: '100px', opacity: 0 }, { y: 0, opacity: 1, ease: Power2.EaseInOut }, "start")
